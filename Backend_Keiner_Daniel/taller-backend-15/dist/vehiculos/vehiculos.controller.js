...
let VehiculosController = class VehiculosController {
    ...
    async updateVehiculo(id, updateVehiculoDto) {
...
], VehiculosController.prototype, "getVehiculos", null);
__decorate([
    (0, common_1.Get)(':id'),
...
], VehiculosController.prototype, "getVehiculo", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
...
], VehiculosController.prototype, "updateVehiculo", null);
